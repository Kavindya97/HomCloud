...
#        subprocess.call(diphaProcessCommand)
    ...
    for filename in args.inputs:
        ...
        bc = PeriodicBoundaryCondition(*args.periodic) if args.periodic else None
        ...
        filtration.compute_diagram_and_save(output, 1, args.algorithm)
...
def argument_parser():
    ...
    parser.add_argument("inputs", metavar="INPUTS", nargs = '+', help="input file name")
    return parser
